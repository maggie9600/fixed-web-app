...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->setFrom('noreply@email.com', 'Chatapp');
            ...
            $mail->Body = '
            <p>Thank you for registering for ChatApp .</p>
                <p>This is a verification email, please click the link to verify your email address.</p>
                <p><a href="http://localhost:8888/chatapp/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
